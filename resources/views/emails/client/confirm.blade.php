            ...
            <meta name="viewport" content="width=device-width"> <!-- Forcing initial-scale shouldn't be necessary -->
                <meta http-equiv="X-UA-Compatible" content="IE=edge"> <!-- Use the latest (edge) version of IE rendering engine -->
                    <meta name="x-apple-disable-message-reformatting">  <!-- Disable auto-scale in iOS 10 Mail entirely -->
                        <title>Activating Provider Account</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
                                                                            ...
                                                                            <table  cellpadding="10" cellspacing="0" >
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="left">*******{{substr(Request::input('password'), -2)}} </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                        </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td style="padding: 20px 40px; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555;">
                                                                                        ...
                                                                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: auto;">
                                                                                            <tr>
                                                                                                <td style="border-radius: 3px; background: #0b86e1; text-align: center;" class="button-td">
                                                                                                    ...
                                                                                                    <?php
                                                                                                    ?>
                                                                                                    <a href="{{url('/').'/client/auth/active?u='.strtolower(trim(str_replace(' ', '',$row['username']))).'&c='.$row['activation_code']}}" style="background: #0b86e1; border: 15px solid #0b86e1; font-family: sans-serif; font-size: 13px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-a">
                                                                                        ...
                                                                                        <p style="color: #ccc;">Or you can copy the link below on your browser<br/>
                                                                                            <a href="{{App::make('url')->to('/')}}/provider">{{App::make("url")->to('/')}}/provider</a>
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
