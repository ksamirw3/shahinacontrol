...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>User Account Change Password</title>
            ...
            <tr>
                ...
                <td class="header container" style="display: block!important;max-width: 600px!important;margin: 0 auto!important;clear: both!important;">
                    ...
                    <div class="content" style="padding: 15px;max-width: 600px;margin: 0 auto;display: block;">
                        <table bgcolor="#fff">
                            <tr>
                                <td><img width="250px" src="{{App::make('url')->to('/')}}/assets/admin/img/PhuLogo.png" /></td>
                            </tr>
                            <tr>
                                <td align="right">
                                    <h4 class="collapse" style="margin: 0;padding: 0;color: #2ba6cb;"> Change Password
                                    </h4>
                                </td>
                            </tr>
                        </table>
