                                                    ...
                                                    <tr>
                                                        <td style="padding: 20px 40px; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555;">
                                                            ...
                                                            <br><br>
                                                                    ...
                                                                    <tr>
                                                                        <td bgcolor="#dd4b39" align="center" height="100%" valign="top" width="100%" style="padding:20px 0; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #fff;">
                                                                            <p style="font-size: 17px;">
                                                                                schedule table for your sessions 
                                                                            </p>
                                                                            <table  cellpadding="10" cellspacing="0" >
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td  align="right" > From </td>
                                                                                        <td align="left" > {{$data->start or 'all'}} </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td  align="right" > To </td>
                                                                                        <td align="left">  {{$data->end or 'all'}} </td>
                                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        <td bgcolor="#ffffff">
                                                                            <table role="presentation" cellspacing="0" cellpadding="0" border="1" width="100%" style="text-align: center">
                                                                                <thead>
                                                                                    <tr>
                                                                                        <th width="1%">{{__('admin.no')}}</th>
                                                                                        <th width="5%">{{__('admin.group')}}</th>
                                                                                        <th width="5%">{{__('admin.course')}}</th>
                                                                                        <th width="5%">{{__('admin.lab')}}</th>
                                                                                        <th width="5%">{{__('admin.date')}}</th>
                                                                                        <th width="5%">{{__('admin.start')}}</th>
                                                                                        <th width="5%">{{__('admin.end')}}</th>
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td width="1%">{{$session->no}}</td>
                                                                                        <td width="1%">{{@$session->groups->name}}</td>
                                                                                        <td width="1%">{{@$session->courses->name}}</th>
                                                                                            <td width="1%">{{@$session->lab->name}}</td>
                                                                                            <td width="1%">{{@$session->date}}</td>
                                                                                            <td width="1%">{{@$session->start_time}}</td>
                                                                                            <td width="1%">{{@$session->end_time}}</td>
                                                                                    </tr>
                                                                                    @endforeach
                                                                                </tbody>
                                                                            </table>
                                                                    ...
                                                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 680px;">
                                                                        <tr>
                                                                            <td style="padding: 40px 10px;width: 100%;font-size: 12px; font-family: sans-serif; mso-height-rule: exactly; line-height:18px; text-align: center; color: #888888;">
                                                                                ...
                                                                                <br><br>
                                                                                        Amit-Learning<br><span class="mobile-link--footer">El Salam Tower, Cornish El Maadi, next to El Salam International Hospital، 2nd Floor، Athar an Nabi, Maadi، Cairo Governorate, Egypt</span><br><span class="mobile-link--footer">(+2) 25262060</span>
                                                                                                <br><br>
