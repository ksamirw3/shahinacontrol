                                                                    ...
                                                                    <tr>
                                                                        <td bgcolor="#dd4b39" align="center" height="100%" valign="top" width="100%" style="padding:20px 0; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #fff;">
                                                                            ...
                                                                            <p style="font-size: 17px;">
                                                                                ...
                                                                                we would to notify you that you are assiaen 
                                                                            </p>
                                                                          
                                                                              <p style="font-size: 17px;">
                                                                               We would like to inform you, <br/>
                                                                               that are registered in the Group ({{$data->group->name}}).
                                                                               We would like to inform you, <br/>
                                                                               first session will be {{$data->group->start_date}}
                                                                               We would like to inform you, <br/>
                                                                               promptly at {{$data->group->start_time}}  Please come on time
                                                                               We would like to inform you, <br/>
