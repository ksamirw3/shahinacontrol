                                                                           ...
                                                                           <table  cellpadding="10" cellspacing="0" >
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="left" > {{$data->birth_date }} </td>
                                                                                    </tr>
                                                                                   
                                                                                    <tr>
                                                                                        <td  align="right" > university </td>
                                                                                        <td align="left" > {{$data->university }} </td>
                                                                                    </tr>
                                                                                   
                                                                                    <tr>
                                                                                        <td  align="right" > faculty </td>
                                                                                        <td align="left" > {{$data->faculty }} </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td  align="right" > department </td>
                                                                                        <td align="left" > {{$data->dept }} </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td  align="right" > faculty </td>
                                                                                        <td align="left" > {{$data->faculty }} </td>
                                                                              ...
                                                                              <p style="font-size: 17px;">
                                                                               if there is some thing wrong please let us know
