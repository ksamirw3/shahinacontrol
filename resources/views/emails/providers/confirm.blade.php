...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Activate Provider Account</title>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p class="lead" style="font-size: 17px;">
                                      Here is your Account Info from {{env("SITE_NAME")}}
                                    </p>
                                    <!-- social & contact -->
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td align="center" width="54%">
                                                    <a href="mailto:{{Request::input('email')}}" target="_blank" style="color:#000;">{{Request::input('email')}}</a>
                                                </td>
                                            </tr>
                                            <tr>
                                    ...
                                    <br/>
                                    <p>
                                       The Activate your account please click on the link below
                                    </p>
                                    <p>
                                        <a href="{{App::make('url')->to('/')}}/account/auth/activate/{{@$row['confirm_token']}}"><strong>تفعيل</strong></a>
                                    </p>
                                </td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                <td align="center">
                                    <p style="text-align: center;">
                                        <a href="{{App::make('url')->to('/')}}/account" style="color: #FFFFFF;">{{env("SITE_NAME")}}</a>
                                    </p>
                                </td>
                            </tr>
                        </table>
