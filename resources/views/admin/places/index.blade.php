...
<div class="text-center">
    ...
    <code>{{ __('admin.Search for place by name in arabic or english') }}</code>
    ...
    <div class="table-responsive">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered display resize">
            <thead>
                <tr>
                    <th width="25%">{{__('admin.Name EN')}}</th>
                    <th width="25%">{{__('admin.Name AR')}}</th>
                    <th width="25%">{{__('admin.Category Name')}}</th>
                    <th width="25%">{{__('admin.Actions')}}</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($rows as $row)
                <tr>
                    ...
                    <td class="center">{{@$row->category->name_ar}}</td>
