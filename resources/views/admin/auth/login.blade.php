...
@section('content')
    <form id="login-panel" class="form-login boxShadow" method="post" enctype="multipart/form-data" id="form">
        <h2 class="form-login-heading"><img src="assets/s-logo.png" style="width: 85px;"/></h2>
              <div class="login-wrap">
            @include('components.flash_messages') {!! csrf_field() !!}
...
<body>
  <div class="login">
	<h1>شاحنة</h1>
    <form id="login-panel" class="form-login boxShadow" action="" method="post" enctype="multipart/form-data" id="form">
                    @include('components.flash_messages') {!! csrf_field() !!}
